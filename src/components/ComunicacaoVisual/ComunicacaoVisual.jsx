...
import { FaArrowRight, FaEye } from "react-icons/fa"; // Ícones
...
const ComunicacaoVisualData = [
  {
    id: 1,
    img: prt1,
    title: "Comunicação Visual 01",
  ...
  },
  {
    id: 5,
    img: prt5,
    title: "Comunicação Visual 05",
    galleryType: "grafica5",
    aosDelay: "800", // Atraso para a animação AOS
  },
];

// Componente ComunicacaoVisual
const ComunicacaoVisual = () => {
  ...
  return (
    <div id="Comunicacao" className="mt-14 mb-12 px-4">
      <div className="container mx-auto p-8 rounded-lg shadow-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">
        ...
        <div className="text-center mb-10 max-w-[600px] mx-auto p-4 rounded-lg shadow-sm bg-gray-100 dark:bg-gray-700">
          <h1 data-aos="fade-up" className="text-3xl font-extrabold tracking-wide text-gray-800 dark:text-gray-200 drop-shadow-lg flex items-center justify-center">
            <FaEye className="mr-2 text-blue-600 dark:text-blue-400" /> Comunicação Visual
          </h1>
        </div>
        {/* Seção do corpo */}
        <div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
            ...
            {ComunicacaoVisualData.map((data) => (
              <div
                key={data.id}
                data-aos="fade-up"
...
export default ComunicacaoVisual;
